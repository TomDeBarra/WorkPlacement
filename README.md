...
When the Grafana stack is installed via terminal + Docker, program can be run and it will locally send logs, traces and metrics to Tempo, Loki and Prometheus respectively. The controller is there to facilitate this task.
